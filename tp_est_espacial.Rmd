...
elevaciones_vgm <- variogram(log(elevacion)~1, elevaciones)

#graficamos
plot(elevaciones_vgm)
```
...
```{r}
elevaciones_vgm_ajustado <- fit.variogram(elevaciones_vgm, model=vgm("Sph"))
elevaciones_vgm_ajustado

plot(elevaciones_vgm, elevaciones_vgm_ajustado)
```


Como podemos ver: al ajustar, el *rango* se encuentra cerca de 24.000.
